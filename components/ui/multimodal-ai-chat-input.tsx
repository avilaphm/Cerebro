...
function PureSuggestedActions({
  ...
  const suggestedActions = [
    {
      title: 'How can AI',
      label: 'help my business?',
      action: 'How can AI help my business?',
    },
    {
      title: 'How much does',
      label: 'it usually cost?',
      action: 'How much does it usually cost?',
    },
    {
      title: 'What tasks can',
      label: 'actually be automated?',
      action: 'What tasks can actually be automated?',
    },
    {
      title: 'How fast can',
      label: 'I see results?',
      action: 'How fast can I see results?',
    },
  ];
...
export type { Attachment, UIMessage, VisibilityType };
